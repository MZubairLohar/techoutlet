  ...
  <footer className="bg-black text-primary-foreground">
    <div className="container mx-auto px-4 lg:px-8 py-16">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div>
          ...
          <p className="text-primary-foreground/60 text-sm leading-relaxed">
            Premium mobile repair service. Fast, reliable, and certified
          ...
          <div className="flex gap-3 mt-6">
            {[Facebook, Twitter, Instagram, Youtube].map((Icon, i) => (
              <a
                key={i}
                href="#"
                className="w-10 h-10 rounded-full bg-primary-foreground/10 flex items-center justify-center hover:bg-red-600 transition-colors"
              >
      ...
      <div className="border-t border-primary-foreground/10 mt-12 pt-8 text-center text-sm text-primary-foreground/40">
        © <span className="text-red-600">2026</span> TECHOUTLET LTD. All rights
        reserved.
      </div>
    </div>
  </footer>
